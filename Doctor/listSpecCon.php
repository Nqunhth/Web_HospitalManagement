                ...
                <ul class="card-list" id="myUL">
                    ...
                    <div class="pagination center">
                        ...
                        if ($current_page > 1 && $total_page > 1) {
                            echo '<a class="page" href="/Web_HospitalManagement/Doctor/listSpecCon.php?page=' . ($current_page - 1) . '">Prev</a> ';
                        }
                        ...
                        for ($i = 1; $i <= $total_page; $i++) {
                            if ($i == $current_page) {
                                ...
                                echo '<a class="page" href="/Web_HospitalManagement/Doctor/listSpecCon.php?page=' . $i . '">' . $i . '</a> ';
                            }
                        }
                        if ($current_page < $total_page && $total_page > 1) {
                            echo '<a class="page" href="/Web_HospitalManagement/Doctor/listSpecCon.php?page=' . ($current_page + 1) . '">Next</a> ';
                        }
                        ?>
                    </div>
                </ul>
